 ...
 // invoke fPost (if not-null) on t1 (using "accept").
    ...
    public static void main(String[] args) {
        ...
        for (int p = 0;p < 8; p++) {
            ...
            benchmarkSort(array, n+"Random array:" , new InsertionSort<>(), m);
            n = n *2;
        }
        System.out.println("**************************************");
        ...
        for (int p = 0; p< 8; p++) {
            ...
            benchmarkSort(array, n+"Ordered array--size:" , new InsertionSort<>(), m);
            n = n * 2;
        }
        System.out.println("**************************************");
        ...
        for (int p = 0; p < 8; p++) {
            Integer[] array = new Integer[n];
            for (int i = 0; i < n; i++) array[i] = n-i;
            benchmarkSort(array, n+"Reverse-ordered array :", new InsertionSort<>(), m);
            n = n * 2;
        }
        System.out.println("**************************************");
        ...
        for (int p = 0; p < 8; p++) {
            ...
            benchmarkSort(array,n+ "Partially-ordered array: " , new InsertionSort<>(), m);
            n = n * 2;
        }
        System.out.println("**************************************");
